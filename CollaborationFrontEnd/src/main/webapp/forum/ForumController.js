...
angular.module('myApp').controller('ForumController', ['$scope','$location','$rootScope','ForumService', function($scope,$location,$rootScope,ForumService) {
	...
	var self = this;
	self.forum={forumId:'',forumTitle:'',forumContent:'',userId:'$rootScope.userId',userName:'$rootScope.userName'};
    self.forums=[];
    ...
    function CreateForum(forum){
    	forum.userId = $rootScope.userId;
    	forum.userName = $rootScope.userName;
